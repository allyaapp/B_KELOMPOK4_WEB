...
Route::post('simpan/admin', [UserController::class, 'store']);
// Route::get('admin/create', 'UserController@create')->name('create');
...
Route::group(['middleware' => ['auth']], function () {
    Route::get('customer/customer', [CostumersController::class, 'tampil']);
    /* route product */
