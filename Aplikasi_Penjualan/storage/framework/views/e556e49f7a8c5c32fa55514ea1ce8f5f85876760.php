                ...
                <div class="col-lg-6">
                    <div class="login_box_img">
                        <div class="hover">
                            ...
                            <a class="button button-account" href="<?php echo e(Route('costumer.login')); ?>">Login Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login_form_inner register_form_inner">
                        ...
                        <form class="row login_form" method="POST" action="<?php echo e(route('costumer.register.post')); ?>" id="register_form" >
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\New folder\htdocs\Aplikasi_Penjualan\resources\views/costumerAuth/register.blade.php ENDPATH**/ ?>