                        ...
                        <div class="card-header" >
                            <h4 class="card-title me-2" >
                                ...
                                <div class="float-right">
                                    ...
                                    <a href="<?php echo e(route('product.create')); ?>" class="btn btn-primary btn-sm" style="margin-left: 20px;">Tambah</a>
                                </div>
                            </h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label>Berat: <span class="badge badge-info"><?php echo e($row->weight); ?> gr</span></label><br>
                                                <label>Stok: <span class="badge badge-info"><?php echo e($row->stock); ?></span></label>
                                            </td>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\New folder\htdocs\Aplikasi_Penjualan\resources\views/produk/produk.blade.php ENDPATH**/ ?>