...
class _SearchPageState extends State<SearchPage> {
  ...
  void itemImage() {
    listItemImage.add("assets/images/kripca.png");
    listItemImage.add("assets/images/ms_glow.png");
    listItemImage.add("assets/images/hoodie_hijau.png");
  }
      ...
      child: Column(
        children: <Widget>[
          ...
          ConstrainedBox(
            ...
            child: ListView.builder(
              itemBuilder: (context, index) {
                return recentSearchListViewItem(listItemImage[index], index);
              },
              itemCount: listItemImage.length,
              primary: false,
              scrollDirection: Axis.horizontal,
            ),
          )
  ...
  recentSearchListViewItem(String listShoesImage, int index) {
    ...
    if (index == this.listItemImage.length - 1) {
      rightMargin = 16;
    }
    return Container(
      margin: EdgeInsets.only(left: leftMargin, right: rightMargin),
